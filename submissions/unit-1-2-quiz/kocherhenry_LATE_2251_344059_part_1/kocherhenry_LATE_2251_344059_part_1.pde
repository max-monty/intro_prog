...
void draw() {
  ...
  g = g % 255;
  // EXPLANATION: it wraps the value of g back to 0 if it suprasses 255. These keeps the green value dynamic, stopping it from reaching 255 then remaining there.
  // 1/1
