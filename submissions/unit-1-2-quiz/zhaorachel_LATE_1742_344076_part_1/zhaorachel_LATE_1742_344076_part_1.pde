...
void draw() {
  ...
  g = g % 255;
  // EXPLANATION: finds the remainder (0) when g is divided by 255 using mod and ensuring it stays within a 0-255 range
  // 1/1
  ...
  // 1/2 circles should be different sizes. should use height and width
  // system variables to center circle
