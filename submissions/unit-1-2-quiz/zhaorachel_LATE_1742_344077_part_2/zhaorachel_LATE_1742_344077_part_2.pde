...
void setup() {
  ...
  x = width/2;
  y = height/2;
  xspeed = 3; // Choose a number between 1-5
...
void draw() {
  ...
  rect(0, 0, 500, 500);
  // .5/1 should use height and width system variables
  ...
  // with x and y variable it would be x/2 and y/2 but imo mouseX mouseY looks cooler
  // 1/1
